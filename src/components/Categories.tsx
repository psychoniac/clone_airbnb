...
export default function Categories() {
    ...
    const categoriesList = [
        ...
        {name: 'A deux roues', icon: <MdOutlineTwoWheeler />},
        {name: 'A la ferme', icon: <GiFarmTractor />},
        ...
        {name: 'Forets', icon: <GiTreeBranch />},
        {name: 'Cascades', icon: <GiWaterfall />},
        {name: 'Chateaux', icon: <GiCastle />},
        {name: 'Plaines', icon: <GiWheat />},
        {name: 'Retraites spirituelle', icon: <GiYinYang />},
    ];
