...
export default function Search() {
  return (
    <div className="border-b-2 pb-5">
        <div className="max-w-[670px] shadow-md rounded-full m-auto border border-gray-300 flex items-center gap-1 overflow-hidden">
            <button className="flex flex-col px-5 py-2 hover:rounded-full hover:bg-gray-200">
             ...
             <button className="flex flex-col px-5 py-2 hover:rounded-full hover:bg-gray-200">
                ...
                <span className="text-sm">Ajouter des voyageurs</span>
            </button>
